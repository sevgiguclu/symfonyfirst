...
/* image/new.html.twig */
class __TwigTemplate_3543bb192b4375e92ece4dd2975391071d504ef779ab60dc873a52b2eaa3b94d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<table class=\"table\">
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["image"]) {
            ...
            // line 58
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_image_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["image"], "id", [], "any", false, false, false, 58), "hid" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 58, $this->source); })())]), "html", null, true);
...
<div class=\"row\">
    <div class=\"col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12\">
        <div class=\"card\">
            <h5 class=\"card-header\">Resim Düzenleme</h5>
            <div class=\"card-body\">
                <form name=\"image\" action=\"{{ path('user_image_new',{'id':id}) }}\" method=\"post\" enctype=\"multipart/form-data\">
                    <div class=\"form-group\">
                        <label for=\"inputText3\" class=\"col-form-label\">Title</label>
                        <input id=\"image_title\" type=\"text\" class=\"form-control\" name=\"image[title]\" maxlength=\"50\">
...
", "image/new.html.twig", "C:\\xampp\\htdocs\\myProject\\templates\\image\\new.html.twig");
    }
}
