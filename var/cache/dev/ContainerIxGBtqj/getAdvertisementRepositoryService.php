...
// Returns the private 'App\Repository\Admin\AdvertisementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\Admin\\AdvertisementRepository.php';

return $this->privates['App\\Repository\\Admin\\AdvertisementRepository'] = new \App\Repository\Admin\AdvertisementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
